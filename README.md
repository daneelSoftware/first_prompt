...
First you need to onboard at : [OpenAI](https://platform.openai.com/) and [Anthropic](https://console.anthropic.com/) to get API_KEYs from your account and provide credits for the payload
You need both to submit a prompt
